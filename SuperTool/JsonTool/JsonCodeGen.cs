...
namespace SuperTool.JsonTool
{
    public class JsonCodeGen
    {
        ...
        private Dictionary<string, JsonArray> codeDict = new Dictionary<string, JsonArray>();
        ...
        public Dictionary<string, JsonArray> GetSettingData()
        {
            ...
            foreach (var item in jsonArray)
            {
                ...
                codeDict.Add(name, childObj["file"]!.AsArray());
            }
